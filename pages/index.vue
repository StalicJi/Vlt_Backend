    ...
    initBarChart() {
      ...
      const option = {
        ...
        series: [
          {
            data: [
              { value: this.ProjecBusinessNumber, itemStyle: { color: "#ad7596", opacity: 0.8 } },
              { value: this.ProjectExecutingNumber, itemStyle: { color: "#87AD75", opacity: 0.8 } },
              { value:  this.ProjectWarrantygNumber, itemStyle: { color: "#047AE7", opacity: 0.8 } },
              { value: this.ProjectClosethecaseNumber, itemStyle: { color: "#e3a74d", opacity: 0.8 } },
            ],
            type: "bar",
          },
        ],
